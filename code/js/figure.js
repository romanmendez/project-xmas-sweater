class Figure {
  ...
  draw() {
    this.ctx.beginPath();
    this.ctx.moveTo(this.sX + this.figure[0], this.sY + this.figure[1]);
    for (let i = 0; i < this.figure.length; i += 2) {
      this.ctx.lineTo(this.sX + this.figure[i], this.sY + this.figure[i + 1]);
    }
    this.ctx.fill();
    this.ctx.closePath();
  }
  ...
  getFigure(figure) {
    let Coordinates = {
      darkStart: [48, 0, 8, 94, 14, 94, 100, 32, 0, 32, 90, 94, 93, 91, 11, 36, 89, 36, 16, 88, 18, 80, 49, 10, 93, 93, 95, 87],
      ...
      picket: [50, 40, 100, 90, 100, 100, 50, 50, 0, 100, 0, 90],
